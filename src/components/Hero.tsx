...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-float-1 absolute top-1/4 left-1/4 w-32 h-32 bg-primary/20 rounded-full blur-[80px]"></div>
      <div className="bg-float-2 absolute bottom-1/4 right-1/4 w-48 h-48 bg-blue-600/10 rounded-full blur-[100px]"></div>
